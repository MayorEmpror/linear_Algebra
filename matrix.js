...
function convert_to_reduce_echlone_form(d_row1, d_row2, d_row3) {
  console.log(d_row1 + "the  roq 1 hte")
  d_row1 = convert_entity_to_1(d_row1, 0);
  console.log(d_row1 + "the  roq22 1 hte")
  console.log(d_row2 + "the 1 hte")
  d_row2 = convert_entity_to_0(d_row1, d_row2, 0); 
  console.log(d_row2 + "the 2 hte")
...
function convert_entity_to_1(matrix, index) {
  ...
  while (revert) {
    if (matrix[index] > 1) {
      ...
      console.log(matrix + "this is a test ");
      revert === false;
...
function convert_entity_to_0(matrix1, matrix2, index) {
  console.log(matrix2 + ";lekj;fak")
  var temp_matrix1 = [];
  var Incomplete = true;
  console.log(matrix2[index] +"index ")
  while (Incomplete) {
    if ((matrix2[index] = 0)) {
      console.log(matrix2 + " this is the matrix w1")
      Incomplete = false;// exception under construction
    } else if (matrix2[index] < 1) {
      console.log(matrix2[index] +"index ")
      matrix1 = math.multiply(matrix1, matrix2[index]);
      console.log(matrix2 + " this is the matrix w2")
     ...
     console.log(matrix2)
      ...
      console.log(matrix2 + " this is the matrix w3")
